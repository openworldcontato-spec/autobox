...
const steps = [
  {
    ...
    desc: "Veja a frota premium, filtre por tipo, preço e cidade. Sem caça ao tesouro digital.",
  ...
  },
  {
    ...
    desc: "Selecione datas, extras e confirme a reserva em poucos minutos com pagamento em reais.",
  ...
  },
  {
    ...
    desc: "Entregamos em hotel, aeroporto ou endereço dentro da área atendida. Operação premium, sem caos.",
    color: "bg-green-50 text-green-600",
  },
  {
    icon: Car,
    step: "04",
    title: "Dirija e aproveite",
    desc: "Suporte 24/7, seguro incluso e experiência pensada para web, Android e iOS.",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {steps.map(({ icon: Icon, step, title, desc, color }, i) => (
            <motion.div key={step} initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.15 }} className="relative text-center group">
              {i < steps.length - 1 && <div className="hidden lg:block absolute top-8 left-[calc(50%+2.5rem)] right-0 h-px border-t-2 border-dashed border-gray-200 z-0" />}
