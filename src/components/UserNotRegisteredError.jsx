      ...
      <div className="max-w-md w-full p-8 bg-white rounded-2xl shadow-lg border border-slate-100">
        <div className="text-center">
          ...
          <p className="text-slate-600 mb-8">
            Esta conta ainda não está liberada para usar o AutoBox. Entre em contato com o administrador do app para solicitar acesso.
          </p>
          <div className="p-4 bg-slate-50 rounded-xl text-sm text-slate-600 text-left">
            <p className="font-semibold mb-2">Checklist rápido:</p>
            <ul className="list-disc list-inside space-y-1">
              <li>Confirme se entrou com a conta correta</li>
              <li>Peça liberação ao administrador</li>
